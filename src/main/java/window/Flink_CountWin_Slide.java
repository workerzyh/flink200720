 ...
 * @create 2020--12--12--14:54
 */
public class Flink_CountWin_Slide {
    public static void main(String[] args) throws Exception {
        //TODO 滑动计数窗口，计算10s的wordcount
        //获取执行环境
        ...
        //开窗
        WindowedStream<Tuple2<String, Integer>, Tuple, GlobalWindow> winDS = keyByStream.countWindow(5,2);
        //聚合
